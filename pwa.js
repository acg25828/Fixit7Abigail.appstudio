...
const cacheName = 'Fixit7Abigail-2020-10-04 19:21:17.367061'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit7Abigail'.length) === 'Fixit7Abigail') {
